...
public class AdministerVaccineToPatientSatelliteClinicJPanel extends javax.swing.JPanel {
    ...
    public AdministerVaccineToPatientSatelliteClinicJPanel(JPanel workContainer, HospitalEnterprise hospital,SatelliteClinicOrganization satelliteOrg,UserAccount userAccount , Business business,Patient patient, StateNetwork state) {
        initComponents();
