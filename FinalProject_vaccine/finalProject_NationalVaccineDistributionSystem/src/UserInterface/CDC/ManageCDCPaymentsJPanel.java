 ...
 * @author Vaibhav
 */
public class ManageCDCPaymentsJPanel extends javax.swing.JPanel {

    /**
     * Creates new form ManageCDCPaymentsJPanel
     */
    ...
    public ManageCDCPaymentsJPanel(JPanel workContainer, UserAccount userAccount,Business business,CDC cdcEnterprise,CDCOrganization cdcOrg) {
        initComponents();
        ...
        this.cdcOrg = cdcOrg;
        populateTable();
        currentBalancejTextField.setText(String.valueOf(cdcEnterprise.getFinancialAccount().getTotalBalance()));
    }
    ...
    private void payAmountjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_payAmountjButtonActionPerformed
        ...
        if(cdcEnterprise.getFinancialAccount().getTotalBalance() < amount)
        {
        ...
        cdcEnterprise.getFinancialAccount().setTotalBalance(cdcEnterprise.getFinancialAccount().getTotalBalance() - amount);
