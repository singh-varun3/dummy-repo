...
public class VARESReportingJPanel extends javax.swing.JPanel {
    ...
    public VARESReportingJPanel(JPanel workContainer, UserAccount userAccount,Business business,CDC cdcEnterprise,CDCOrganization cdcOrg) {
        initComponents();
    ...
    private void initComponents() {
        ...
        summaryjTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "State", "Total Vaccines Administered", "No. of Failed Vaccines"
            }
        ) {
    ...
    private void viewDetailsjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewDetailsjButtonActionPerformed
        ...
        VARESCityReportingJPanel panel = new VARESCityReportingJPanel(workContainer,userAccount, business, cdcEnterprise, cdcOrg, state);
